<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminViewElectionDate.aspx.cs" Inherits="AdminViewElectionDate" %>
            ...
            <td style ="text-align :center ;">
               ...
               BackColor="#CCCCCC" 
                    ...
                    CellSpacing="2" ForeColor="Black" Width="544px" 
                       AutoGenerateDeleteButton="True" DataKeyNames="state,edate" 
                       EmptyDataText="Record Not Found!!!" onrowdeleting="GridView1_RowDeleting" >
                    <Columns >
